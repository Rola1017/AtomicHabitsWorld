...
const LIST_BASE = "/law/insurance/claims-and-general"

export default async function ClaimsAndGeneralPage() {
  const articles = await getPostsByCategory("claims-and-general")
