...
const LIST_BASE = "/law/insurance/corporate-liability"

export default async function CorporateLiabilityPage() {
  const articles = await getPostsByCategory("corporate-liability")
