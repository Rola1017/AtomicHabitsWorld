...
const LIST_BASE = "/law/insurance/personal-insurance/life-insurance/savings"

export default async function SavingsInsurancePage() {
  const articles = await getPostsByCategory("savings-insurance")
