...
const LIST_BASE = "/law/civil/torts-and-damages"

export default async function TortsAndDamagesPage() {
  const articles = await getPostsByCategory("torts-and-damages")
