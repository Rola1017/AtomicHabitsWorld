...
const LIST_BASE = "/law/civil/family-and-inheritance"

export default async function FamilyAndInheritancePage() {
  const articles = await getPostsByCategory("family-and-inheritance")
