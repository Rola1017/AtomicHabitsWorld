...
export default async function ChildProtectionAndEducationTrustsPage() {
  const articles = await getPostsByCategory("child-protection-and-education-trusts")
