...
const LIST_BASE = "/law/civil/family-and-inheritance/family-trust-and-asset-protection"

export default async function FamilyTrustAndAssetProtectionPage() {
  const articles = await getPostsByCategory("family-trust-and-asset-protection")
