...
const LIST_BASE = "/law/civil/property-law"

export default async function PropertyLawPage() {
  const articles = await getPostsByCategory("property-law")
