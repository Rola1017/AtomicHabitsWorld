...
const NATIONAL_PENSION_WELFARE_SITE_PATH =
  "labor/social/national-pension-welfare"
...
function getNationalPensionWelfareWpCategorySlug(): string {
  return getWpCategorySlugForSitePath(NATIONAL_PENSION_WELFARE_SITE_PATH)
}
...
export async function generateMetadata({
  ...
  const wpCat = getNationalPensionWelfareWpCategorySlug()
  ...
  const pathBase = `/law/${NATIONAL_PENSION_WELFARE_SITE_PATH}`
...
export default async function NationalPensionWelfarePostPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
