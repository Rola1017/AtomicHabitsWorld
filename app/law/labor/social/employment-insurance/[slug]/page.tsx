...
const EMPLOYMENT_INSURANCE_SITE_PATH = "labor/social/employment-insurance"
...
function getEmploymentInsuranceWpCategorySlug(): string {
  return getWpCategorySlugForSitePath(EMPLOYMENT_INSURANCE_SITE_PATH)
}
...
export async function generateMetadata({
  ...
  const wpCat = getEmploymentInsuranceWpCategorySlug()
  ...
  const pathBase = `/law/${EMPLOYMENT_INSURANCE_SITE_PATH}`
...
export default async function EmploymentInsurancePostPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
