...
const SOCIAL_SITE_PATH = "labor/social"
...
function getSocialWpCategorySlug(): string {
  return getWpCategorySlugForSitePath(SOCIAL_SITE_PATH)
}
...
export async function generateMetadata({
  ...
  const wpCat = getSocialWpCategorySlug()
  ...
  const pathBase = `/law/${SOCIAL_SITE_PATH}`
...
export default async function SocialLaborPostPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
