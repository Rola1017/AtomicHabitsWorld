...
const OCCUPATIONAL_ACCIDENT_SITE_PATH =
...
function getOccupationalAccidentWpCategorySlug(): string {
  return getWpCategorySlugForSitePath(OCCUPATIONAL_ACCIDENT_SITE_PATH)
}
...
export async function generateMetadata({
  ...
  const wpCat = getOccupationalAccidentWpCategorySlug()
  ...
  const pathBase = `/law/${OCCUPATIONAL_ACCIDENT_SITE_PATH}`
...
export default async function OccupationalAccidentInsurancePostPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
