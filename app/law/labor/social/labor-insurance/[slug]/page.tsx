...
const LABOR_INSURANCE_SITE_PATH = "labor/social/labor-insurance"
...
function getLaborInsuranceWpCategorySlug(): string {
  return getWpCategorySlugForSitePath(LABOR_INSURANCE_SITE_PATH)
}
...
export async function generateMetadata({
  ...
  const wpCat = getLaborInsuranceWpCategorySlug()
  ...
  const pathBase = `/law/${LABOR_INSURANCE_SITE_PATH}`
...
export default async function LaborInsurancePostPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
