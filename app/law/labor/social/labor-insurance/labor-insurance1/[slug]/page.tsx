...
const SITE_PATH = "labor/social/labor-insurance/labor-insurance1"
...
function getWpCat(): string {
  return getWpCategorySlugForSitePath(SITE_PATH)
}
...
export default async function LaborInsurance1PostPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
  ...
  return (
    <CategoryLayout
      ...
      heroTitle={["勞保1"]}
      heroLatin="Labor insurance · subcategory."
    >
