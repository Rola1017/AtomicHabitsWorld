...
const TERMINATION_LAYOFF_RETIREMENT_SITE_PATH =
...
function getTerminationLayoffRetirementWpCategorySlug(): string {
  return getWpCategorySlugForSitePath(TERMINATION_LAYOFF_RETIREMENT_SITE_PATH)
}
...
export async function generateMetadata({
  ...
  const wpCat = getTerminationLayoffRetirementWpCategorySlug()
  ...
  const pathBase = `/law/${TERMINATION_LAYOFF_RETIREMENT_SITE_PATH}`
...
export default async function TerminationLayoffRetirementPostPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
