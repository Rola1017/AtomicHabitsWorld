...
import {
  fetchLaborPostByRequiredWpCategorySlug,
} from "@/lib/wp-labor-post"
import { fetchLaborSidebarPosts } from "@/lib/wp-labor-sidebar-posts"

const INDIVIDUAL_SITE_PATH = "labor/individual"
...
function getIndividualWpCategorySlug(): string {
  return getWpCategorySlugForSitePath(INDIVIDUAL_SITE_PATH)
}
...
export async function generateMetadata({
  ...
  const wpCat = getIndividualWpCategorySlug()
  ...
  const pathBase = `/law/${INDIVIDUAL_SITE_PATH}`
...
export default async function IndividualLaborPostPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
