...
const LIST_BASE = "/law/labor/individual/gender-equality-bullying"

export default async function GenderEqualityBullyingPage() {
  const articles = await getPostsByCategory("gender-equality-bullying")
