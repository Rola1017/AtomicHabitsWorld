...
const WAGE_HOURS_LEAVE_SITE_PATH = "labor/individual/wage-hours-leave"
...
function getWageHoursLeaveWpCategorySlug(): string {
  return getWpCategorySlugForSitePath(WAGE_HOURS_LEAVE_SITE_PATH)
}
...
export async function generateMetadata({
  ...
  const wpCat = getWageHoursLeaveWpCategorySlug()
  ...
  const pathBase = `/law/${WAGE_HOURS_LEAVE_SITE_PATH}`
...
export default async function WageHoursLeavePostPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
