...
const LIST_BASE = "/law/labor/individual/wage-hours-leave"

export default async function WageHoursLeavePage() {
  const articles = await getPostsByCategory("wage-hours-leave")
