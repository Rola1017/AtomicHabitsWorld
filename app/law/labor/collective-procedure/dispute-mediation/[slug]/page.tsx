...
const DISPUTE_MEDIATION_SITE_PATH =
  "labor/collective-procedure/dispute-mediation"
...
function getDisputeMediationWpCategorySlug(): string {
  return getWpCategorySlugForSitePath(DISPUTE_MEDIATION_SITE_PATH)
}
...
export async function generateMetadata({
  ...
  const wpCat = getDisputeMediationWpCategorySlug()
  ...
  const pathBase = `/law/${DISPUTE_MEDIATION_SITE_PATH}`
...
export default async function DisputeMediationPostPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
