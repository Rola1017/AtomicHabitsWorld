...
const LIST_BASE = "/law/labor/collective-procedure/dispute-mediation"

export default async function DisputeMediationPage() {
  const articles = await getPostsByCategory("dispute-mediation")
