...
const LIST_BASE = "/law/labor/collective-procedure"

export default async function CollectiveLaborProcedurePage() {
  const articles = await getPostsByCategory("collective-procedure")
