...
const ADMIN_REMEDIES_LABOR_INSPECTION_SITE_PATH =
...
function getAdminRemediesLaborInspectionWpCategorySlug(): string {
  return getWpCategorySlugForSitePath(ADMIN_REMEDIES_LABOR_INSPECTION_SITE_PATH)
}
...
export async function generateMetadata({
  ...
  const wpCat = getAdminRemediesLaborInspectionWpCategorySlug()
  ...
  const pathBase = `/law/${ADMIN_REMEDIES_LABOR_INSPECTION_SITE_PATH}`
...
export default async function AdminRemediesLaborInspectionPostPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
