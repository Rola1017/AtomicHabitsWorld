...
const LIST_BASE = "/law/labor/collective-procedure/admin-remedies-labor-inspection"

export default async function AdminRemediesLaborInspectionPage() {
  const articles = await getPostsByCategory("admin-remedies-labor-inspection")
