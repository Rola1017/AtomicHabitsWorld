...
const BACK_BUTTON_CLASS =
  "inline-flex h-11 w-11 cursor-pointer items-center justify-center rounded-none border-2 border-black bg-white/80 text-[#101A3A] shadow-sm ring-1 ring-black/5 hover:opacity-90 transition-opacity"
